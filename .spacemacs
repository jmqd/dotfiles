...
`dotspacemacs/user-config' first."
  ;; jqq@google.com work-related settings
  ;; (require 'google)
  ;; (require 'google-ycmd)
  (server-start))
...
you should place your code here."
  ...
  (evil-leader/set-key "wi" 'evil-window-up
    "wk" 'evil-window-down "wj" 'evil-window-left)
  (setq-default flycheck-gcc-language-standard
                "c++17")
  ;; org-mode GTD
  ...
  (setq org-capture-templates '(("t" "Todo [inbox]"
                                 entry
                                 (file+headline "~/cloud/mcqueen.jordan/inbox.org"
                                                "Tasks")
                                 "* TODO %i%?")))
  (setq org-agenda-files '("~/cloud/mcqueen.jordan/inbox.org" "~/cloud/mcqueen.jordan/gtd.org"))
  (setq org-agenda-custom-commands '(("w" "Work"
                                      tags-todo
                                      "@work"
...
(custom-set-variables
 ...
 '(package-selected-packages (quote (emacs-amazon-libs tide typescript-mode auctex-latexmk
                                                       lv dash-docs transient zenburn-theme zen-and-art-theme
                                                       zeal-at-point yaml-mode xterm-color xkcd winum
                                                       white-sand-theme underwater-theme ujelly-theme
                                                       typit mmt twilight-theme twilight-bright-theme
                                                       twilight-anti-bright-theme toxi-theme tangotango-theme
                                                       tango-plus-theme tango-2-theme sunny-day-theme
                                                       sudoku sublime-themes subatomic256-theme subatomic-theme
                                                       stickyfunc-enhance srefactor spotify spacegray-theme
                                                       soothe-theme solarized-theme soft-stone-theme
                                                       soft-morning-theme soft-charcoal-theme smyx-theme
                                                       shell-pop seti-theme reverse-theme rebecca-theme
                                                       ranger railscasts-theme purple-haze-theme
                                                       professional-theme plantuml-mode planet-theme
                                                       phoenix-dark-pink-theme phoenix-dark-mono-theme
                                                       pdf-tools tablist pacmacs organic-green-theme
                                                       org-mime omtose-phellack-theme oldlace-theme
                                                       occidental-theme obsidian-theme noctilux-theme
                                                       naquadah-theme mustang-theme multi-term monokai-theme
                                                       monochrome-theme molokai-theme moe-theme minimal-theme
                                                       material-theme majapahit-theme madhat2r-theme
                                                       lush-theme light-soap-theme jbeans-theme jazz-theme
                                                       ir-black-theme intero inkpot-theme hlint-refactor
                                                       hindent heroku-theme hemisu-theme helm-spotify-plus
                                                       multi helm-hoogle helm-dash hc-zenburn-theme
                                                       haskell-snippets gruvbox-theme gruber-darker-theme
                                                       grandshell-theme gotham-theme gandalf-theme
                                                       fuzzy flyspell-correct-helm flyspell-correct
                                                       flycheck-pos-tip flycheck-haskell flycheck
                                                       flatui-theme flatland-theme farmhouse-theme
                                                       exotica-theme espresso-theme eshell-z eshell-prompt-extras
                                                       esh-help erc-yt erc-view-log erc-social-graph
                                                       erc-image erc-hl-nicks dracula-theme django-theme
                                                       disaster darktooth-theme autothemer darkokai-theme
                                                       darkmine-theme darkburn-theme dakrone-theme
                                                       cyberpunk-theme company-quickhelp pos-tip
                                                       company-ghci company-ghc ghc haskell-mode
                                                       company-cabal company-c-headers company-auctex
                                                       color-theme-sanityinc-tomorrow color-theme-sanityinc-solarized
                                                       cmm-mode cmake-mode clues-theme clang-format
                                                       cherry-blossom-theme busybee-theme bubbleberry-theme
                                                       birds-of-paradise-plus-theme badwolf-theme
                                                       auto-dictionary auctex apropospriate-theme
                                                       anti-zenburn-theme ample-zen-theme ample-theme
                                                       alect-themes afternoon-theme 2048 -game web-mode
                                                       tagedit slim-mode scss-mode sass-mode pug-mode
                                                       less-css-mode helm-css-scss haml-mode emmet-mode
                                                       company-web web-completion-data rvm ruby-tools
                                                       ruby-test-mode rubocop rspec-mode robe rbenv
                                                       rake minitest chruby bundler inf-ruby smeargle
                                                       ...
                                                       git-commit ghub let-alist with-editor web-beautify
                                                       livid-mode skewer-mode simple-httpd json-mode
                                                       json-snatcher json-reformat js2-refactor multiple-cursors
                                                       js2-mode js-doc company-tern dash-functional
                                                       tern coffee-mode company-emacs-eclim eclim
                                                       helm-company helm-c-yasnippet company-statistics
                                                       company-anaconda company auto-yasnippet yasnippet
                                                       ac-ispell auto-complete org-projectile org-category-capture
                                                       org-present org org-pomodoro alert log4e gntp
                                                       org-download htmlize gnuplot yapfify pyvenv
                                                       ...
                                                       markdown-mode gh-md ws-butler window-numbering
                                                       ...
                                                       info+ indent-guide ido-vertical-mode hydra
                                                       hungry-delete hl-todo highlight-parentheses
                                                       highlight-numbers parent-mode highlight-indentation
                                                       hide-comnt help-fns+ helm-themes helm-swoop
                                                       helm-projectile helm-mode-manager helm-make
                                                       projectile pkg-info epl helm-flx helm-descbinds
                                                       helm-ag google-translate golden-ratio flx-ido
                                                       flx fill-column-indicator fancy-battery eyebrowse
                                                       ...
                                                       undo-tree eval-sexp-fu highlight dumb-jump
                                                       f s diminish define-word column-enforce-mode
                                                       clean-aindent-mode bind-map bind-key auto-highlight-symbol
                                                       auto-compile packed dash aggressive-indent
                                                       adaptive-wrap ace-window ace-link ace-jump-helm-line
                                                       helm avy helm-core popup async quelpa package-build
                                                       spacemacs-theme))))
(custom-set-faces
