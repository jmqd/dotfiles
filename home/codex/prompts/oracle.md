---
description: Ask Oracle GPT-5.6 Sol through the Oracle CLI and fold the answer into this Codex thread
...
Route through `oracle` with ChatGPT browser mode and GPT-5.6 Sol:

```sh
oracle --engine browser --model gpt-5.6-sol -p "<standalone prompt>"
```
