...
- [ ] Track an upstream fix for the phone companion's `rsa 0.9.10` dependency (`RUSTSEC-2023-0071`, Marvin timing side channel; no fixed upgrade available). `bin/audit-deps.sh` reports this without an exception.
