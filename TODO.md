...
- [ ] Track upstream fixes for `openai/codex rust-v0.145.0`: cargo-audit still reports `hickory-proto 0.25.2` (`RUSTSEC-2026-0118`, with no fixed upgrade currently reported; `RUSTSEC-2026-0119`, fixed in `>=0.26.1`), `quick-xml 0.39.4` (`RUSTSEC-2026-0194`, `RUSTSEC-2026-0195`, fixed in `>=0.41.0`), and `quinn-proto 0.11.14` (`RUSTSEC-2026-0185`, fixed in `>=0.11.15`) in `codex-rs/Cargo.lock`, plus `tar 0.4.44` (`RUSTSEC-2026-0067`, `RUSTSEC-2026-0068`, fixed in `>=0.4.45`) in `tools/argument-comment-lint/Cargo.lock`. Version `rust-v0.145.0` was the latest GitHub release audited on 2026-07-23.
- [ ] Track upstream fixes for `lox/notion-cli v0.6.0`: module-mode govulncheck reports 14 findings in Go `1.26.4` (`GO-2026-4970`, `GO-2026-5856`, fixed in `>=1.26.5`), `golang.org/x/text v0.33.0` (`GO-2026-5970`, fixed in `>=0.39.0`), `golang.org/x/net v0.49.0` (`GO-2026-4918`, fixed in `>=0.53.0`; `GO-2026-5025`–`GO-2026-5030`, fixed in `>=0.55.0`; `GO-2026-5942`, fixed in `>=0.56.0`), `golang.org/x/sys v0.40.0` (`GO-2026-5024`, fixed in `>=0.44.0`), `github.com/yuin/goldmark v1.7.8` (`GO-2026-5320`, fixed in `>=1.7.17`), and `github.com/buger/jsonparser v1.1.1` (`GO-2026-4514`, fixed in `>=1.1.2`). Version `v0.6.0` was the latest GitHub release audited on 2026-07-17.
